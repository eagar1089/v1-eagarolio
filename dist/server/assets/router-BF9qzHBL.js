...
const appCss = "/assets/styles-CNuj8eNN.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Sagar Parab Portfolio" },
      { name: "description", content: "Portfolio of Sagar Parab, Linux Administrator and DevOps Engineer." },
      { name: "author", content: "Sagar Parab" },
      { property: "og:title", content: "Sagar Parab Portfolio" },
      { property: "og:description", content: "Infrastructure, DevOps, and full-stack projects by Sagar Parab." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@sagarparab" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-oOPVj1XJ.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component"),
  head: () => ({
    meta: [{
      title: "Sagar Parab — Linux Administrator & DevOps Engineer"
    }, {
      name: "description",
      content: "Sagar Parab is a Linux Administrator and DevOps Engineer building resilient infrastructure, CI/CD pipelines, and full-stack applications."
    }, {
      property: "og:title",
      content: "Sagar Parab — Linux Admin & DevOps Engineer"
    }, {
      property: "og:description",
      content: "Resilient infrastructure, automation, and full-stack craftsmanship."
    }]
  })
});
